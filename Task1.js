...
person.email = "malsoaimi379@gmail.com";
...
console.log(hasKey(person, "nkkjdhdi"));
...
function printAllTitlesOfMovies(movies, key)
{
...
printAllTitlesOfMovies(movies, "title");
